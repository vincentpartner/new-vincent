...
(function () {
  ...
  function render(target) {
    ...
    // Zielpuffer explizit auf transparent leeren — ohne preserveDrawingBuffer ist er
    // sonst undefiniert und flackert bei Repaints (Hover) zwischen alt und neu.
    if (target == null) { gl.bindFramebuffer(gl.FRAMEBUFFER, null); gl.clear(gl.COLOR_BUFFER_BIT); }
    if (config.SHADING) {
